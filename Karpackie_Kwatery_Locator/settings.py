...
"""
    Cloudflare
"""
CLOUDFLARE_ZONE_TOKEN=env("CLOUDFLARE_ZONE_API")
...
if DEBUG==1:
    ...
    CORS_ALLOWED_ORIGINS = env.list("CORS_ALLOWED_ORIGINS_PROD", default=[]) # works with heroku and "prod" docker
